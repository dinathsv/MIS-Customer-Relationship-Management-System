        ...
        <section class="glass-panel list-section">
          <div class="section-header">
            ...
            <button @click="fetchComplaints" class="refresh-btn" title="Refresh">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" :class="{'spin': isFetching}"><polyline points="23 4 23 10 17 10"></polyline><path d="M20.49 15a9 9 0 1 1-2.12-9.36L23 10"></path></svg>
            </button>
          </div>
